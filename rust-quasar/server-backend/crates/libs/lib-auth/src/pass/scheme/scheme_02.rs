...
impl Scheme for Scheme02 {
    fn hash(&self, to_hash: &crate::pass::ContentToHash) -> Result<String> {
    ...
    fn validate(&self, to_hash: &crate::pass::ContentToHash, pwd_ref: &str) -> Result<()> {
        let argon2 = get_argon2();
...
mod tests {
    ...
    fn test_scheme_02_hash_into_b64u_ok() -> Result<()> {
        ...
        let fx_res = "$argon2id$v=19$m=19456,t=2,p=1$8F6JYdatQIaeeKbeBl5UUw$7gLSktgyKurWE8hC5ebe6ePUcEyKI9mqj06up7ETNLg";
